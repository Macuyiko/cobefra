...
@Metric(genericName = "Proper Completion", author = "Rozinat et al.", classification = "Recall")
public class ProperCompletion extends RozinatMetric {
	...
	protected void obtainResult(ConformanceAnalysisResults result) {
		...
		setResult(myResult.getFractionOfProperlyTerminated());
	}
	...
	protected void setMetric() {
		...
		settings.selectedMetrics.add(ConformanceSettings.Metric.ProperCompletion);
	}
